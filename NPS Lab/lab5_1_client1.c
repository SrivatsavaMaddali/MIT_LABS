...
// PORT number
#define PORT 3088//make it same as server port number
...
int main()
{
	...
	serverAddr.sin_addr.s_addr= inet_addr("127.0.0.1");//server ip address                             // 127.0.0.1 is Loopback IP
	...
	while (1) 
	{
		int sentbytes=send(clientSocket,"Institute Of",strlen("Institute Of"),0);
